...
const Logo = ({
  ...
  return (
    <div className={`flex gap-1.5 items-center ${classNames.base}`}>
      <svg
        width={width}
        height={height}
        viewBox="0 0 360 360"
        ...
        className={`text-black dark:text-white ${classNames.image}`}
      >
      ...
      <div
        className={`text-black font-medium tracking-tight font-montserrat ${classNames.text}`}
      >
        Chirp
      </div>
    </div>
